...
def get_comet_experiment(config, is_offline=False, offline_dir=None):
...
experiment = get_comet_experiment(config, args.offline, log_path)
...
for epoch in range(start_epoch, config['solver']['num_epochs']):
	...
	with tqdm(total=iterations) as pbar:
		...
		for i, batch in enumerate(combined_dataloader):
			...
			# do forward
			out = model.decoder(batch, model.encoder(batch))
