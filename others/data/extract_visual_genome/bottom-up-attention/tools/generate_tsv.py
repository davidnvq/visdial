...
# ./tools/generate_tsv.py --gpu 0 --cfg experiments/cfgs/faster_rcnn_end2end_resnet.yml --def models/vg/ResNet-101/faster_rcnn_end2end_final/test.prototxt --out test2014_resnet101_faster_rcnn_genome.tsv --net data/resnet101_faster_rcnn_final_iter_320000.caffemodel --split /home/quanguet/datasets/visdial/VisualDialog_val2018
