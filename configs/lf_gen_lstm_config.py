...
CONFIG = {
	'seed'         : 0,
	'comet_project': 'tmp',
	'config_name'  : 'lf_gen_lstm',

	'callbacks'    : {
		'validate'            : True,
		'resume'              : False,
		'path_pretrained_ckpt': '',
		'path_dir_save_ckpt'  : osp(HOME_PATH, 'checkpoints/visdial/lf_gen_lstm')
		},
...
def get_lf_gen_lstm_config(config_path=None, is_save_config=False):
