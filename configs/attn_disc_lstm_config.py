...
CONFIG = {
    ...
    'callbacks'    : {
        ...
        'path_dir_save_ckpt'  : '/media/local_workspace/quang/checkpoints/visdial/attn_disc_lstm_v5'
    },
...
def get_attn_disc_lstm_config(config_path=None):
