...
def augment_sentence():
	sent2sent_dict = {
		'is it' : [['yes it is', 'yes', 'yes , it is', 'yea i believe so', 'i think so', 'i believe so', 'yes i think so',
		            'it looks so', 'looks like it is']

		            ['no', 'no it is not', "i can't tell", "i can't ", "no."]],

		'does she' : [
			['nope', 'no', 'not that i can see', "i can't see 1", 'no i do not', "i don't think so", 'no , unfortunately']],
