...
HOME_PATH = '/home/administrator/quang'
DATA_PATH = f'{HOME_PATH}/datasets/visdial'
LOG_PATH = '/home/administrator/quang/workspace/log/tensorboard'
...
def get_comet_experiment(config):
    ...
    os.system(f"zip -qr {config_name}.zip /home/administrator/quang/workspace/repos/visdial -x '*.git*' '*.ipynb_checkpoints*' '*.idea*' '*__pycache__*'")
...
def get_training_config_and_args():
    ...
    dir = '/home/administrator/quang/workspace/repos/visdial/configs'
    if not os.path.exists(dir):
        os.system(f'mkdir -p {dir}')
...
def add_dataset_args(parser):
    ...
    group.add_argument('--genome_path', metavar='PATH',
                       default=osp(DATA_PATH, 'genome/1600-400-20'))
    return group
