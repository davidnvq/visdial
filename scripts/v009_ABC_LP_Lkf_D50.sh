...
--train_feat_img_path "/media/local_workspace/quang/datasets/visdial/bottom-up-attention/trainval_resnet101_faster_rcnn_genome__num_boxes_(50, 50).h5" \
>> /home/quang/workspace/log/qsub/v009_ABC_LP_Lkf_D50.txt