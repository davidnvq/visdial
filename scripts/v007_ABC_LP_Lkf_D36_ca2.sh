...
#$-cwd
#$-V
#$-o /home/quang/workspace/log/qsub/v007_ABC_LP_Lkf_D36_ca2.log
#$-q main.q@yagi05.vision.is.tohoku

export CUDA_VISIBLE_DEVICES=$SGE_GPU
python /home/quang/workspace/repos/visdial/train.py \
--config_name v007_ABC_LP_Lkf_D36_ca2 \
--decoder_type misc \
--init_lr 0.005 \
--batch_size 8 \
--num_epochs 30 \
...
>> /home/quang/workspace/log/qsub/v007_ABC_LP_Lkf_D36_ca2.txt