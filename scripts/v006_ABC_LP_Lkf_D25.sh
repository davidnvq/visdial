...
--train_feat_img_path "/media/local_workspace/quang/datasets/visdial/bottom-up-attention/trainval_resnet101_faster_rcnn_genome__num_boxes_(25, 25).h5" \
>> /home/quang/workspace/log/qsub/v005_ABC_LP_Lkf_D25.txt