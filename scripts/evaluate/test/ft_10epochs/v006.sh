...
--split "test" \
--decoder_type 'disc' \
--save_ranks_path '/home/quang/ranks/ft_10epochs/test/v006_ABC_LP_lkf_D25_disc.json' \
--output_path '/home/quang/ranks/ft_10epochs/test/v006_ABC_LP_lkf_D25_disc.pkl'
