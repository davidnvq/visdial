...
--split "test" \
--decoder_type 'disc' \
--save_ranks_path '/home/quang/ranks/ft_10epochs/test/v002_abc_LP_lkf_D36_disc.json' \
--output_path '/home/quang/ranks/ft_10epochs/test/v002_abc_LP_lkf_D36_disc.pkl'