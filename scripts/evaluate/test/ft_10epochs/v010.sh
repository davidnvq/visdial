...
--split "test" \
--decoder_type 'disc' \
--save_ranks_path '/home/quang/ranks/ft_10epochs/test/v010_ABC_LP_Lkf_DAda_disc.json' \
--output_path '/home/quang/ranks/ft_10epochs/test/v010_ABC_LP_Lkf_DAda_disc.pkl'
