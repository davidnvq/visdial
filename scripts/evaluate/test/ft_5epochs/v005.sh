...
--split "test" \
--decoder_type 'disc' \
--save_ranks_path '/home/quang/ranks/ft_5epochs/test/v005_ABC_LP_Lkf_D36_disc.json' \
--output_path '/home/quang/ranks/ft_5epochs/test/v005_ABC_LP_Lkf_D36_disc.pkl'