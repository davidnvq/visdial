...
--split "val" \
--decoder_type 'disc' \
--save_ranks_path '/home/quang/ranks/ft_5epochs/val/v010_ABC_LP_Lkf_DAda_disc.json' \
--output_path '/home/quang/ranks/ft_5epochs/val/v010_ABC_LP_Lkf_DAda_disc.pkl'
