...
#$-cwd
#$-V
#$-o /home/quang/workspace/log/qsub/train_simple/s00.log
#$-q main.q@yagi15.vision.is.tohoku

export CUDA_VISIBLE_DEVICES=$SGE_GPU
python /home/quang/workspace/repos/visdial/train.py \
--config_name train_simple/s01_simple_branch_cosine \
--decoder_type misc \
...
>> /home/quang/workspace/log/qsub/train_simple/s00.txt