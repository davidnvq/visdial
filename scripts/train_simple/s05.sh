...
#$-cwd
#$-V
#$-o /home/quang/workspace/log/qsub/train_simple/s05.log
#$-q main.q@yagi17.vision.is.tohoku

export CUDA_VISIBLE_DEVICES=$SGE_GPU
python /home/quang/workspace/repos/visdial/train.py \
--config_name train_simple/12epochs/s05_simple_branch \
--decoder_type misc \
--init_lr 0.001 \
...
>> /home/quang/workspace/log/qsub/train_simple/s05.txt