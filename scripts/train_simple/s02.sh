...
#$-cwd
#$-V
#$-o /home/quang/workspace/log/qsub/train_simple/s02.log
#$-q main.q@yagi09.vision.is.tohoku

export CUDA_VISIBLE_DEVICES=$SGE_GPU
python /home/quang/workspace/repos/visdial/train.py \
--config_name train_simple/12epochs/s02_simple_12epochs \
--decoder_type misc \
--init_lr 0.001 \
...
>> /home/quang/workspace/log/qsub/train_simple/s02.txt