...
#$-cwd
#$-V
#$-o /home/quang/workspace/log/qsub/train_simple/s04.log
#$-q main.q@yagi14.vision.is.tohoku

export CUDA_VISIBLE_DEVICES=$SGE_GPU
python /home/quang/workspace/repos/visdial/train.py \
--config_name train_simple/12epochs/s04_simple_branch_12epochs \
--resume \
--path_pretrained_ckpt '/media/local_workspace/quang/checkpoints/visdial/CVPR/train_simple/12epochs/s04_simple_branch_12epochs/checkpoint_last.pth' \
--decoder_type misc \
--init_lr 0.001 \
...
>> /home/quang/workspace/log/qsub/train_simple/s04.txt